...
const parseHsla = (value) => {
    const match = value.match(/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)%\s*,\s*(\d+(?:\.\d+)?)%\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/i);
    if (!match) {
...
function StatusPanel() {
    ...
    const openColorPicker = SP_REACT.useCallback((key, title) => {
        const color = parseHsla(settings[key]);
        let modal;
        modal = DFL.showModal(SP_JSX.jsx(DFL.ColorPickerModal, { closeModal: () => modal?.Close(), title: title, defaultH: color.h, defaultS: color.s, defaultL: color.l, defaultA: color.a, onConfirm: (nextColor) => {
                void updateSettings({ [key]: nextColor });
            } }));
    }, [settings, updateSettings]);
    const colorButton = (key, label) => (SP_JSX.jsx(DFL.ButtonItem, { disabled: pendingAction !== null, onClick: () => openColorPicker(key, label), layout: "below", description: settings[key], children: SP_JSX.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px" }, children: [SP_JSX.jsx("span", { children: label }), SP_JSX.jsx("span", { style: {
                        width: "42px",
                        height: "18px",
                        borderRadius: "999px",
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsxs(DFL.PanelSection, { title: "Popup Tests", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { disabled: pendingAction !== null, onClick: () => void trigger("test_popup_main"), layout: "below", description: "Shows the standard Xbox-style achievement popup.", children: "Test Main" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { disabled: pendingAction !== null, onClick: () => void trigger("test_xbox_popup"), layout: "below", description: "Shows the Xbox-style popup through the in-game Gamescope overlay.", children: "Test XBOX Popup" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { disabled: pendingAction !== null, onClick: () => void trigger("test_popup_rare"), layout: "below", description: "Shows the rare variant with glow and the rare sound.", children: "Test Rare" }) })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "Settings", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "Popup size", description: "0% hides the banner; 50% is the default size.", value: settings.overlay_size_percent, min: 0, max: 100, step: 10, notchCount: 11, showValue: true, valueSuffix: "%", disabled: pendingAction !== null, onChange: (value) => void updateSettings({ overlay_size_percent: value }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "Volume", description: "50% is the default volume; 0% is silent.", value: settings.volume_percent, min: 0, max: 100, step: 10, notchCount: 11, showValue: true, valueSuffix: "%", disabled: pendingAction !== null, onChange: (value) => void updateSettings({ volume_percent: value }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.DropdownItem, { label: "Normal sound", description: "WAV file for normal achievements.", rgOptions: soundOptions, selectedOption: settings.normal_sound, disabled: pendingAction !== null || soundOptions.length === 0, onChange: (selection) => void updateSettings({ normal_sound: selection.data }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.DropdownItem, { label: "Rare sound", description: "WAV file for rare achievements.", rgOptions: soundOptions, selectedOption: settings.rare_sound, disabled: pendingAction !== null || soundOptions.length === 0, onChange: (selection) => void updateSettings({ rare_sound: selection.data }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: {
                                height: "18px",
                                borderRadius: "999px",
                                background: `linear-gradient(90deg, ${settings.normal_gradient_start}, ${settings.normal_gradient_end})`,
                                border: "1px solid rgba(255,255,255,0.35)",
                            } }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("normal_gradient_start", "Normal gradient start") }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("normal_gradient_end", "Normal gradient end") }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: {
                                height: "18px",
                                borderRadius: "999px",
                                background: `linear-gradient(90deg, ${settings.rare_gradient_start}, ${settings.rare_gradient_end})`,
                                border: "1px solid rgba(255,255,255,0.35)",
                            } }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("rare_gradient_start", "Rare gradient start") }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("rare_gradient_end", "Rare gradient end") }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("normal_circle_color", "Normal circle color") }), SP_JSX.jsx(DFL.PanelSectionRow, { children: colorButton("rare_circle_color", "Rare circle color") })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "Watcher Status", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { disabled: pendingAction !== null, onClick: () => void refreshStatus(), description: "Manually refresh backend status.", children: "Refresh Status" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { children: [SP_JSX.jsxs("div", { children: ["Log watcher: ", SP_JSX.jsx("strong", { children: status?.watcher_running ? "yes" : "no" })] }), SP_JSX.jsxs("div", { children: ["Cache watcher:", " ", SP_JSX.jsx("strong", { children: status?.librarycache_watcher_running ? "yes" : "no" })] }), SP_JSX.jsxs("div", { children: ["Watcher mode: ", status?.watcher_mode ?? "-"] }), SP_JSX.jsxs("div", { children: ["Inotify app: ", status?.last_inotify_event_appid ?? "-", " / latency:", " ", status?.last_queue_latency_ms ?? "-", "ms"] }), SP_JSX.jsxs("div", { children: ["Inotify events: ", status?.processed_inotify_events ?? 0, " / fallback scans:", " ", status?.fallback_scan_count ?? 0] }), SP_JSX.jsxs("div", { children: ["Last inotify path: ", status?.last_inotify_event_path ?? "-"] }), SP_JSX.jsxs("div", { children: ["Parse retry: ", status?.last_parse_retry_error ?? "-"] }), SP_JSX.jsxs("div", { children: ["Steam API:", " ", SP_JSX.jsx("strong", { children: status?.steam_api_enabled
